							...
							<div class="col-md-12">
								<div class="card custom-card">
									...
									<div class="card-body">
							          ...
							          <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($gs,2);?></b></h4></th>
							          </tr>
							          ...
							          <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($grand,2);?></b></h4></th>
							            ...
							            <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($sum2,2);?></b></h4></th>
							          </tr>  


											  <tr>
							            <th colspan="9">Overall Cash Sales</th>
							            <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($all_grand,2);?></b></h4></th>
							          </tr>   
									  <?php } }  ?>	
