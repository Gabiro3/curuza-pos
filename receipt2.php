				...
				<div class="container">
					<div class="inner-body">
					  ...
					  <div id="invoice-POS">
					    ...
					    <center id="top">
					      <div class="logo">
					      	<img src="images/callin-logo.jpg" alt="Callin" width="100" height="65">
					      </div>
					      <div class="info"> <br>
					          ...
					          <div id="table">
					            <table>
					              ...
					              <tr class="service">
					                ...
					                <td class="tableitem"><p class="itemtext">Rwf <?php echo number_format($total,2);?></p></td>
					              </tr>
					              <?php } ?>  
					                ...
					                <td></td>
					                <td class="Rate"><h2>Sub-total</h2></td>
					                <td class="payment"><h2>Rwf <?php echo number_format($grand,2);?></h2></td>
					              </tr>					              
					              ...
					              <tr class="tabletitle">
					                ...
					                <td class="payment"><h2>Rwf <?php echo number_format($discount,2);?></h2></td>
					              </tr>

					               <tr class="tabletitle">
					                <td></td>
					                <td class="Rate"><h2>Cash Paid</h2></td>
					                <td class="payment"><h2>Rwf <?php echo number_format($tendered,2);?></h2></td>
					              </tr>

					               <tr class="tabletitle">
					                <td></td>
					                <td class="Rate"><h2>Change</h2></td>
					                <td class="payment"><h2>Rwf <?php echo number_format($change,2);?></h2></td>
					              </tr>

					              <tr class="tabletitle">
					                <td></td>
					                <td class="Rate"><h2>Total</h2></td>
					                <td class="payment"><h2>Rwf <b><?php echo number_format($grand-$discount,2);?></b></h2></td>
					              </tr>
