<?php
    ...
    include_once "includes/db_conn.php";
       ...
       $query = mysqli_query($db, "select * from tbl_sales order by sale_id desc LIMIT 0,1")or die(mysqli_error($db));          
...
$pdf->Cell(60,8,'CURUZA POS',1,1,'C');
...
$pdf->Cell(0,4, strtoupper($shop_name), 0, 1, 'C'); // Shop name in uppercase & centered
...
$pdf->SetFont('Arial','BI',8);
$pdf->Cell(20,4,'Buyer: ',0,0,'');
$pdf->Cell(10,4,$buyer_name,0,1,'');

$pdf->SetFont('Arial','BI',8);
$pdf->Cell(20,4,'Buyer Phone: ',0,0,'');
$pdf->Cell(10,4,$buyer_phone,0,1,'');
...
$pdf->Cell(75,3,'© ' . date('Y') . ' Curuza POS - Version 1.0', 0, 1, '');

$pdf->SetX(7);
$pdf->SetFont('Courier','BI',8);
$pdf->Cell(75,3,'Contact Us:    0781255340',0,1,'');
