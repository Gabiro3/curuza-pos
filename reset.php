...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Healthlink Pharma - Reset Password </title>
								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											<img src="assets/img/brand/callin-logo.jpg" class=" d-lg-none header-brand-img text-left float-left mb-4" alt="logo">
											<div class="clearfix"></div>
