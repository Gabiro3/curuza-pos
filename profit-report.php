							...
							<div class="col-md-12">
								<div class="card custom-card">
									...
									<div class="card-body">
				                      ...
				                      while($row = mysqli_fetch_array($query))
				                        {
				                           ...
				                           $i++;
							                ...
							                <tr>
							                	<td><?php echo $i; ?></td>
								                <td>Rwf <?php echo number_format($net_sales,2);       ?></td>
				                        <td>Rwf <?php echo number_format($cogs, 2);           ?></td>
				                        <td>Rwf <?php echo number_format($expenses, 2);       ?></td>
				                        <td>Rwf <?php echo number_format($gross_profit, 2);   ?></td>                
							          ...
							          <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($ns,2);?></b></h4></th>
							          </tr>

							          <tr>
							          <th colspan="9">Total Expenses</th>
							          <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($te,2);?></b></h4></th>
							          </tr>

							          <tr>
							          <th colspan="9">Gross Profits</th>
							          <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($grand,2);?></b></h4></th>
							          </tr>
									  <?php } } ?>
