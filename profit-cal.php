												...
												<div class="">
													...
													<div class="row">
														...
														<label class=""> Net Sales </label>
														 <input type="text" class="form-control" name="net_sales" placeholder="Net Sales(Rwf )" value="<?php echo isset($_POST['net_sales']) ? $_POST['net_sales'] : '' ?>" required>
													    </div>

													    <div class="form-group col-md-6">
														<label class=""> Cost of Goods Sold </label>
														<input class="form-control" required="" placeholder="COGS(Rwf )" value="<?php echo isset($_POST['goods_cost']) ? $_POST['goods_cost'] : '' ?>" name="goods_cost" type="text">
													    </div>


													    <div class="form-group col-md-6">
														<label class=""> Expenses </label>
														<input class="form-control" required="" placeholder="Expenses(Rwf )" value="<?php echo isset($_POST['expenses']) ? $_POST['expenses'] : '' ?>" name="expenses" type="text">
													    </div> 
