									...
									<div class="card-body">
										 ...
										 <?php
						                  ...
						                  <h5 style="font-size: 20px; text-align: center; color: #6259CA;">
						                    <b><?php echo htmlspecialchars($row['shop_name']);?></b> 
						                  </h5>  
						              ...
						              <th colspan="9">OverAll Total</th>     						  
							                 ...
							                 $query = mysqli_query($db,"SELECT * FROM tbl_expenses WHERE date(date_added)>='$start' AND date(date_added)<='$end' ORDER BY date_added")or die(mysqli_error($db));
				                      ...
				                      while($row = mysqli_fetch_array($query))
				                        ...
				                        <td>Rwf <?php echo number_format($expense_amount, 2);        ?></td>                
