							...
							<div class="col-md-12">
								<div class="card custom-card">
									...
									<div class="card-body">
				                      ...
				                      while($row = mysqli_fetch_array($query))
				                        {
							                ...
							                <tr>
							                	<td><?php echo $cust_name; ?></td>
																...
																<td>Rwf <?php echo number_format($amt_p, 2); ?></td>
																<td>Rwf <?php echo number_format($total - $amt_p, 2); ?></td>
							          ...
							          <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($amt_g,2); ?></b></h4></th>
							          </tr>

							          <tr>
							          <th colspan="9">Total Amount Paid</th>
							          <th style="text-align:right;"><h4><b>Rwf <?php echo number_format($amt_pp, 2); ?></b></h4></th>
							          </tr>
									  <?php } } ?>	
