  ...
  <dd class="text-right ml-auto">
    <input class="form-control col-md-6 pull-right" type="text" name="buyer_name" required>
  </dd>
</dl>
...
<dl class="dlist-align">
  <dt>Buyer Phone:</dt>
  <dd class="text-right ml-auto">
    <input class="form-control col-md-6 pull-right" type="text" name="buyer_phone" required>
  </dd>
</dl>
