...
<html lang="en">
	<head>
		...
		<meta name="description" content="Healthlink Pharma -  Admin Panel">
		<meta name="author" content="Calling Ventures">
		<meta name="keywords" content="Healthlink Pharma">

		<!-- Favicon -->
		<link rel="icon" href="images/inventory.png" type="image/x-icon"/>

		<!-- Title -->
		<title> POS | Healthlink Pharma</title>
		...
		<div class="page">
									...
									<div class="row row-sm">
									    ...
									    <div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0 border-right">
											<div class="card-body text-center">
												...
												<h2 class="mb-1 mt-2 number-font"><span class="counter">Rwf </span><?php echo ShowSalesAmt();  ?></h2>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0 border-right">
											<div class="card-body text-center">
												...
												<h2 class="mb-1 mt-2 number-font"><span class="counter">Rwf </span><?php echo ShowDiscountAmt(); ?></h2>
											</div>
										</div>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0 border-right">
											<div class="card-body text-center">
												...
												<h2 class="mb-1 mt-2 number-font"><span class="counter">Rwf </span><?php echo ShowExpenses(); ?></h2>
											</div>
										</div>
										...
										<div class="col-xl-3 col-lg-6 col-sm-6 pr-0 pl-0">
											<div class="card-body text-center">
												...
												<h2 class="mb-1 mt-2 number-font"><span class="counter">Rwf <?php echo ShowCreditAmt();  //ShowProduct()  ?></span></h2>
											</div>
										</div>
			...
			<div class="main-footer text-center">
				<div class="container">
					<div class="row row-sm">
						<div class="col-md-12">
							<span>Copyright © 2025 <a href="#">Healthlink Pharma</a>. All rights reserved.</span>
						</div>
					</div>
				</div>
			</div>
