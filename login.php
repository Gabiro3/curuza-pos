...
<html lang="en">
	<head>
		...
		<meta name="author" content="Healthlink Pharma">
		...
		<!-- Title -->
		<title>Healthlink Pharma | Admin Panel </title>
    ...
    url('images/pharmacy-storage-room.webp');
          /* Full height */
          height: 100vh; 
						...
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-5 pt-4 p-2 pos-absolute">
									<h4 class="mb-4 text-white">Healthlink Pharma</h4>
									<div class="clearfix"></div>
									<img src="images/inventory.png" class="ht-100 mb-0" alt="user">
								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											<img src="images/inventory.png" class=" d-lg-none header-brand-img text-left float-left mb-4" alt="logo">
											<div class="clearfix"></div>
    ...
    <div class="mb-1"><a href="../System/shop-attendant/login.php">Employee login</a></div>
</div>
